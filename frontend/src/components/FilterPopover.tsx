        ...
        <div className="w-full max-w-[420px] glass bg-[#0f0f18] border border-white/10 rounded-2xl shadow-2xl p-6 animate-slide-up max-h-[95vh] flex flex-col pointer-events-auto">
          ...
          <div className="flex items-center justify-between mb-5 shrink-0">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-semibold text-[var(--fg)]">Advanced Filters</h3>
            </div>
            <button 
              onClick={onClose}
              className="p-1 hover:bg-black/5 dark:hover:bg-white/10 rounded-full text-gray-500 hover:text-[var(--fg)] transition-colors"
            >
              <X className="w-4 h-4" />
            </button>
          </div>

          {/* Scrollable Body containing only filters */}
          ...
          <div className="mt-4 pt-4 border-t border-[var(--border-color)] flex items-center justify-between shrink-0">
            <button
              onClick={onClear}
            ...
            <button
              onClick={onClose}
              className="bg-primary hover:bg-primary-hover text-white px-6 py-2.5 rounded-xl text-xs font-bold transition-all shadow-lg shadow-primary/20 hover:scale-105 active:scale-95"
            >
              Apply Filters
            </button>
          </div>
