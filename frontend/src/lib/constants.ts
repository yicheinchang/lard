...
CRITICAL: If is_valid or is_complete is False, you MUST provide a detailed failure_reason explaining what is missing or wrong.`,
  ...
  job_post_check: "You are an expert at identifying job postings. Analyze the provided text and determine if it is a job advertisement or position description. Return whether it is a job post and your confidence level (0.0 to 1.0). Job posts typically contain a job title, company name, responsibilities, and requirements. Non-job content includes news articles, blog posts, 'Page Not Found' errors, or generic corporate homepages."
};
