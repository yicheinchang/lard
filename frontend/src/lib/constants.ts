...
CRITICAL: If is_valid or is_complete is False, you MUST provide a detailed failure_reason explaining what is missing or wrong.`,
  ...
  json_description: "You are an expert at extracting job details from Schema.org JSON-LD data. Reformat the COMPLETE job/position description from the provided JSON fragment into clean Markdown. PRESERVE VERBATIM text. Include existing sections (e.g., 'About the Role', 'Responsibilities', 'Qualifications' etc.) ONLY if they are explicitly present. Do NOT rephrase, do NOT add your own labels or categories, and do NOT invent new headers. CRITICAL: Ensure the description is COMPLETE. Do NOT truncate lists or skip items. Verify that the LAST items in any 'Responsibilities' or 'Requirements' lists are captured verbatim. Do not make up information if it is not present in the text.\nCRITICAL: Do NOT wrap the output in ```markdown blocks.",
