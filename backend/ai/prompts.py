...
DEFAULT_SYSTEM_PROMPTS = {
    "extraction_base": (
        ...
        "RULES:\n"
        "1. IDENTIFICATION: First, determine if the content is a job posting. Set 'is_job_post' and 'likelihood'.\n"
        "2. COMPANY: Look for organization names near the top. Common labels: 'Company', 'Organization', 'Employer'.\n"
        "3. ROLE: Extract the official job title exactly. Include levels (Senior, II) and suffixes.\n"
        "4. JOB ID: Scan for 'Job ID', 'Req #', 'Ref', or 'Position ID'. Prioritize the text body.\n"
        "5. SALARY: Look for currency symbols or 'salary/compensation' labels. Format: '$Min - $Max'.\n"
        "6. DATES: Convert all dates to YYYY-MM-DD. (e.g. 'April 3rd, 2026' -> '2026-04-03').\n"
        "7. DESCRIPTION: Reformat the job body into high-fidelity Markdown. No summaries. No omissions.\n\n"
