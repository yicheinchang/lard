# 🗺️ Lard - Lazy AI-Powered Resume Database (v0.84.3)
...
- `routers/`:
  ...
  - `ai.py`: AI Assistant chat, history, and data extraction endpoints. Includes SSE streaming, session persistence, and **automated filtering of empty tool-calling messages** with structured reasoning extraction.
